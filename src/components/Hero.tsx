...
const Hero = () => {
  return (
    <div className="relative bg-ticket-blue text-white">
      <div className="absolute inset-0 bg-gradient-to-r from-ticket-blue to-ticket-lightBlue opacity-90"></div>
      <div className="relative container mx-auto px-4 py-12 md:py-24">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4 animate-fade-in">
            <Button className="bg-white text-ticket-blue hover:bg-gray-100 hover:text-ticket-blue font-semibold px-6 py-3 rounded-md">
              Find Concerts
            </Button>
